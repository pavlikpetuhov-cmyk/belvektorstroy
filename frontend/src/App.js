      ...
      <section className="bg-[#1C1C1C] py-20 px-6" data-testid="contact-form-section">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <a 
              href="https://wa.me/79257590903?text=Здравствуйте!%20Интересует%20расчёт%20штукатурных%20работ"
              target="_blank"
              rel="noopener noreferrer"
              data-testid="whatsapp-btn"
              className="bg-[#25D366] text-white hover:bg-[#1da851] px-8 py-5 font-bold uppercase tracking-wider transition-all inline-flex items-center justify-center gap-3"
            >
            ...
            <a 
              ...
              className="bg-[#FF5F1F] text-white hover:bg-[#E04F16] px-8 py-5 font-bold uppercase tracking-wider transition-all inline-flex items-center justify-center gap-3"
            >
              <Phone size={24} />
              Позвонить
            </a>
          ...
          <div className="bg-[#0A0A0A] p-6 industrial-border inline-block">
            <p className="text-zinc-400 text-sm mb-2">Телефон для связи</p>
            <a href="tel:+79257590903" className="font-heading text-2xl font-bold text-white hover:text-[#FF5F1F] transition-colors">
              8 925 759 09 03
            </a>
          </div>
        </div>
